...
(function() {
  ...
  function createBanner(config) {
    ...
    if (isTest) {
      chips.innerHTML = `<span class="env-chip ${chipClass}">TEST<span class="env-tooltip"><div class="env-tooltip-title">🧪 ${chainName} · ${tokenSymbol}</div><div class="env-tooltip-body"><p>You're on Sepolia — a safe sandbox.</p><p>Prices are in hUSD (test token).</p><p>Nothing here costs real money. Try it freely.</p><p>Production is coming soon.</p></div></span></span>`;
    } else {
  ...
  async function init(options = {}) {
    ...
    // Mint address in footer (above copyright)
    var footer = document.querySelector('.footer');
    if (footer && !footer.querySelector('.footer-mint')) {
      var copyrightEl = footer.querySelector('p:last-of-type');
      var p = document.createElement('p');
      p.className = 'footer-mint';
      p.style.cssText = 'font-size:0.7rem;color:rgba(255,255,255,0.4);margin:8px 0 4px;font-family:var(--font-mono);letter-spacing:0.01em;';
      p.innerHTML = 'Mint address (auto-generated by <a href="https://www.clanker.world" target="_blank" rel="noopener" style="color:rgba(255,255,255,0.5);text-decoration:none;">clanker</a>): <span style="color:rgba(255,255,255,0.55);">0x3fc4b094D8341C7b69CB62687E3BF96f07986B07</span>';
      if (copyrightEl) {
        footer.insertBefore(p, copyrightEl);
      } else {
